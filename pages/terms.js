	...
	return (
		<Template>
			...
			<p>
				...
				the use of Quote Maker's Website, located at
				https://quotemaker.now.sh/.
			</p>

			<p>
				By accessing this website we assume you accept these terms and
				conditions. Do not continue to use Quote Maker if you do not
			...
			<p>
				We employ the use of cookies. By accessing Quote Maker, you
				agreed to use cookies in agreement with the Quote Maker's
				Privacy Policy.
			</p>
			...
			<p>
				Unless otherwise stated, Quote Maker and/or its licensors own
				the intellectual property rights for all material on Quote
				Maker. All intellectual property rights are reserved. You may
				access this from Quote Maker for your own personal use subjected
			...
			<p>
				...
				website. Quote Maker does not filter, edit, publish or review
				Comments prior to their presence on the website. Comments do not
				reflect the views and opinions of Quote Maker,its agents and/or
				affiliates. Comments reflect the views and opinions of the
				person who post their views and opinions. To the extent
				permitted by applicable laws, Quote Maker shall not be liable
			...
			<p>
				Quote Maker reserves the right to monitor all Comments and to
			...
			<p>
				You hereby grant Quote Maker a non-exclusive license to use,
			...
			<p>
				...
				of Quote Maker; and (d) the link is in the context of general
			...
			<p>
				...
				by sending an e-mail to Quote Maker. Please include your name,
			...
			<p>
				No use of Quote Maker's logo or other artwork will be allowed
