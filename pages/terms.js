						...
						<Col xs={12} sm={12} md={12}>
							<div id="application">
								...
								<p>
									...
									and regulations for the use of Quote Maker's
									Website, located at
								...
								<p>
									...
									continue to use Quote Maker if you do not
									agree to take all of the terms and
									conditions stated on this page. Our Terms
									and Conditions were created with the help of
									the{" "}
								...
								<p>
									...
									prevailing law of Netherlands. Any use of
								...
								<p>
									...
									Quote Maker, you agreed to use cookies in
									agreement with the Quote Maker's Privacy
									Policy.
								</p>
								...
								<p>
									Unless otherwise stated, Quote Maker and/or
									its licensors own the intellectual property
									rights for all material on Quote Maker. All
									intellectual property rights are reserved.
									You may access this from Quote Maker for
								...
								<ul>
									...
									<li>
										Redistribute content from Quote Maker
									</li>
								</ul>
								...
								<p>
									...
									Quote Maker does not filter, edit, publish
									or review Comments prior to their presence
									on the website. Comments do not reflect the
									views and opinions of Quote Maker,its agents
									and/or affiliates. Comments reflect the
									views and opinions of the person who post
									their views and opinions. To the extent
									permitted by applicable laws, Quote Maker
								...
								<p>
									Quote Maker reserves the right to monitor
									all Comments and to remove any Comments
									which can be considered inappropriate,
									offensive or causes breach of these Terms
									and Conditions.
								</p>
								...
								<p>
									You hereby grant Quote Maker a non-exclusive
								...
								<p>
									...
									compensates the absence of Quote Maker; and
								...
								<p>
									...
									by sending an e-mail to Quote Maker. Please
								...
								<p>
									No use of Quote Maker's logo or other
