...
export default function Terms() {
	return (
		<Template>
			...
			<p>Welcome to Quote Maker!</p>

			<p>
				These terms and conditions outline the rules and regulations for the use
				of Quote Maker's Website, located at https://quotemaker.now.sh/.
			</p>

			<p>
				By accessing this website we assume you accept these terms and
				conditions. Do not continue to use Quote Maker if you do not agree to
			...
			<p>
				We employ the use of cookies. By accessing Quote Maker, you agreed to
				use cookies in agreement with the Quote Maker's Privacy Policy.
			</p>
			...
			<p>
				Unless otherwise stated, Quote Maker and/or its licensors own the
				intellectual property rights for all material on Quote Maker. All
				intellectual property rights are reserved. You may access this from
				Quote Maker for your own personal use subjected to restrictions set in
				these terms and conditions.
			</p>

			<p>You must not:</p>
			<ul>
				<li>Republish material from Quote Maker</li>
				<li>Sell, rent or sub-license material from Quote Maker</li>
				<li>Reproduce, duplicate or copy material from Quote Maker</li>
				<li>Redistribute content from Quote Maker</li>
			</ul>
			...
			<p>
				...
				exchange opinions and information in certain areas of the website. Quote
				Maker does not filter, edit, publish or review Comments prior to their
				presence on the website. Comments do not reflect the views and opinions
				of Quote Maker,its agents and/or affiliates. Comments reflect the views
				and opinions of the person who post their views and opinions. To the
				extent permitted by applicable laws, Quote Maker shall not be liable for
			...
			<p>
				Quote Maker reserves the right to monitor all Comments and to remove any
			...
			<p>
				You hereby grant Quote Maker a non-exclusive license to use, reproduce,
			...
			<p>
				...
				the hyperlink compensates the absence of Quote Maker; and (d) the link
			...
			<p>
				...
				e-mail to Quote Maker. Please include your name, your organization name,
			...
			<p>
				No use of Quote Maker's logo or other artwork will be allowed for
